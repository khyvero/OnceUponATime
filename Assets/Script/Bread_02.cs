...
public class Bread_02 : MonoBehaviour, ICatalog, IFood
{
    public const string ID = "food_bread_02";

    IHolder holder;
    IEater eater;

    Vector3 pickPosition = new Vector3(-6f, 0.4f, 0f);
    ...
    {
        Bread_02 bread = value as Bread_02;
